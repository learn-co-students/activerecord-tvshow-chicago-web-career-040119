...
def self.highest_rating
  ...
  #column. hint: if there is a minimum Active Record method,
...
def self.popular_shows
  #popular_shows: returns an array of all of the shows
  #that have a rating greater than 5.
  #hint: use the where Active Record method.
  self.where("rating = ?", 5)
end

def self.shows_by_alphabetical_order
  #shows_by_alphabetical_order: returns an array of all of the shows
  #sorted by alphabetical order according to their names.
